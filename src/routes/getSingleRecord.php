<?php
$app->post('/api/Europeana/getSingleRecord', function ($request, $response, $args) {
    $settings = $this->settings;

    //checking properly formed json
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey', 'collectionId', 'recordId']);
    ...
    $query_str = $settings['api_url'] . "v2/record/".$post_data['args']['collectionId']."/".$post_data['args']['recordId'].".json";
    $body = array();
